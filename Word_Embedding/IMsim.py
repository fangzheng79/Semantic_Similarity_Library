...
def calculate_similarity(source_doc, target_doc, embedding="Glove", threshold=0):
    ...
    if embedding == "Word2Vec":
        w2v_model = KeyedVectors.load_word2vec_format('Word_Embedding/data/GoogleNews-vectors-negative300.bin', binary=True)
        ...
        glove_model = KeyedVectors.load_word2vec_format("Word_Embedding/data/datatest_word2vec.txt")
        ...
        fasttext_model = FastText.load_fasttext_format('Word_Embedding/data/cc.en.300.bin')
